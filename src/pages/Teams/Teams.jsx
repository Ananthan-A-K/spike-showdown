...
const TEAMS = [
  ...
  // },
  {
    ...
    captain: 'Gautham K',
    // college: 'IIT Bombay',
    players: ["Gautham K", "Yadhunandan", "Udayasoorya", "Abhishek A", "Meric"],
    rank: 0,
    wins: 0,
    losses: 0,
    status: 'Confirmed',
  ...
  },
  {
    ...
    captain: 'KASHINATH V',
    // college: 'IIT Bombay',
    players: ["KASHINATH V","ABHIJITH AS","GIRI","ADHAL DEV","SREEHARI","NEERAJ P"],
    rank: 0,
    wins: 0,
    losses: 0,
    status: 'Confirmed',
  ...
  },
  {
    ...
    captain: 'SiYoN TPA',
    // college: 'IIT Bombay',
    players: ["SnoW","NareN","SiyoN","Kayanl","MobZ"],
    rank: 0,
    wins: 0,
    losses: 0,
    status: 'Confirmed',
  ...
  },
  {
    ...
    captain: 'DRAEKO',
    // college: 'IIT Bombay',
    players: ["DRAEKO","VOLTIC","FROST","LUFFY","TITAN","DABI","NOISY"],
    rank: 0,
    wins: 0,
    losses: 0,
    status: 'Confirmed',
